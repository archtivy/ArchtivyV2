...
export function NotificationDropdown({ onClose }: NotificationDropdownProps) {
  ...
  return (
    <div
      ...
      className="absolute right-0 top-full z-[100] mt-2 w-[380px] max-w-[calc(100vw-2rem)] overflow-hidden rounded border border-zinc-200/80 bg-white shadow-[0_4px_16px_rgba(0,0,0,0.06),0_1px_3px_rgba(0,0,0,0.04)] dark:border-zinc-700/80 dark:bg-zinc-900 dark:shadow-[0_4px_24px_rgba(0,0,0,0.5)]"
    >
      {/* Header */}
