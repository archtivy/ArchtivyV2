...
/**
 * The dominant search field in a directory control bar. Shared by /projects
 * and /products — the two differ only in placeholder text, and forking it
 * would be the fifth near-duplicate in this codebase.
 *
...
export function DirectorySearchBar({
  ...
  placeholder: string;
  /** Accessible name; the placeholder is not a substitute for one. */
  label?: string;
}) {
  return (
    <form
