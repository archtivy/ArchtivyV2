...
const SIGN_IN_COMPLETE_URL = "/";

const SHARE_SUBTITLE = "Sign in to share your work on Archtivy";
...
export default function SignInPage() {
  ...
  const defaultSubtitle = "Enter your credentials to continue.";
  const subtitle = fromShare ? SHARE_SUBTITLE : defaultSubtitle;
  ...
  const signInWithOAuth = (strategy: OAuthStrategy) => {
    ...
    signIn
      .authenticateWithRedirect({
        ...
        redirectUrlComplete: SIGN_IN_COMPLETE_URL,
      })
      .catch((err) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (signInAttempt.status === "complete") {
        ...
        router.push(SIGN_IN_COMPLETE_URL);
        return;
      }
  ...
  if (showEmailCode) {
    return (
      <AuthSplitLayout title="Verify your email" subtitle="A verification code has been sent to your email.">
  ...
  return (
    <AuthSplitLayout title="Sign in" subtitle={subtitle}>
